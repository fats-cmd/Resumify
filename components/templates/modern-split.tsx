      ...
      <div className="w-full bg-white shadow-lg mx-auto" style={{ maxWidth: "1000px" }}>
        ...
        <div className="grid grid-cols-3 min-h-[1414px]">
          ...
          <div className="col-span-1 bg-gray-800 text-white relative">
            ...
            {/* Profile Image */}
            <div className="relative z-10 mx-auto mt-10 mb-6">
              <div className="w-48 h-48 rounded-full bg-white p-3 mx-auto overflow-hidden">
                {data.basics?.image ? (
                  <Image 
            ...
            <div className="px-8 py-4">
              ...
              <div className="flex items-center mb-4">
                <div className="w-5 h-10 bg-amber-500 mr-3"></div>
                ...
                {data.basics?.phone && (
                  <div className="flex items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm">{data.basics.phone}</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {data.basics?.email && (
                  <div className="flex items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm break-all">{data.basics.email}</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {data.basics?.website && (
                  <div className="flex items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm break-all">{data.basics.website}</p>
                      </div>
                    </div>
                  </div>
                )}
            ...
            {/* Divider */}
            <div className="border-t border-gray-600 w-4/5 mx-auto my-6"></div>
                ...
                {data.references?.map((reference, index) => (
                  <div key={index} className="mb-4">
                    <div className="flex items-center mb-1">
                      <div className="w-2 h-2 rounded-full bg-amber-500 mr-3"></div>
                      <h3 className="font-bold uppercase text-sm">{reference.name}</h3>
                    </div>
              ...
              <div className="space-y-6">
                {data.educationItems?.map((education, index) => (
                  <div key={index} className="mb-4">
                    <div className="flex items-center mb-1">
                      <div className="w-2 h-2 rounded-full bg-amber-500 mr-3"></div>
                      <h3 className="font-bold uppercase text-sm">{education.institution}</h3>
                    </div>
                    <div className="ml-8 space-y-1 text-sm">
          ...
          <div className="col-span-2 bg-white text-gray-800 relative">
            ...
            <div className="p-10 bg-gray-100 border-b border-gray-200">
              <div className="relative pl-8 border-l-4 border-amber-500">
                ...
                <p className="text-xl tracking-wide uppercase text-gray-600">{data.basics?.label || 'Your Profession'}</p>
              </div>
            </div>
            ...
            <div className="p-10">
                ...
                {data.work?.map((work, index) => (
                  <div key={index} className="relative pl-8 border-l border-gray-200">
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        <h3 className="text-lg font-bold uppercase">{work.position}</h3>
                        <p className="text-gray-600 italic">{work.name} / {work.location}</p>
                      </div>
              ...
              {/* Skills List */}
              <div className="pl-8 grid grid-cols-2 gap-y-4 gap-x-8">
